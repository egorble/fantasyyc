      ...
      {isMegaETH ? (
        ...
        <div className="bg-gradient-to-br from-orange-500 via-orange-600 to-red-600 rounded-xl p-4 relative overflow-hidden shadow-lg shrink-0 flex flex-col justify-between min-h-[200px]">
          ...
          <div className="relative z-10">
            ...
            <button
              onClick={onOpenPack}
              className="w-full bg-white hover:bg-gray-100 text-orange-600 py-2.5 rounded-lg font-black text-sm uppercase tracking-wider transition-all duration-300 ease-in-out flex items-center justify-center active:scale-95 shadow-md"
            >
              Buy Pack
            </button>
          </div>
