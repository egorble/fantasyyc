...
const TournamentCTA: React.FC<TournamentCTAProps> = ({ onNavigate }) => {
    ...
    return (
        <div className="my-8">
            <div className="relative overflow-hidden rounded-2xl border border-yc-orange/30 bg-gradient-to-r from-orange-50 via-white to-orange-50 dark:from-[#1A0F00] dark:via-[#0D0D0D] dark:to-[#1A0F00] p-6 md:p-8 group hover:border-yc-orange/60 transition-all duration-500">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                    ...
                    <div className="flex flex-col items-end gap-4 shrink-0">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="text-center bg-white/80 dark:bg-black/50 rounded-xl px-4 py-3 border border-gray-200 dark:border-gray-800">
                                ...
                                <p className="text-xl font-black text-yc-orange font-mono">
                                    {tournament.prizePool} XTZ
                                </p>
                            </div>
                            <div className="text-center bg-white/80 dark:bg-black/50 rounded-xl px-4 py-3 border border-gray-200 dark:border-gray-800">
                                <div className="flex items-center gap-1 mb-1">
                        ...
                        <button
                            ...
                            className="bg-yc-orange hover:bg-orange-600 text-white px-8 py-3 rounded-xl font-black text-sm uppercase tracking-wider transition-all flex items-center shadow-lg shadow-orange-500/20 active:scale-95 group"
                        >
                            Join Tournament
