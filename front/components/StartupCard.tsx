...
const StartupCard: React.FC<StartupCardProps> = ({ startup, onClick }) => {
  ...
  return (
    ...
    >
      ...
      {/* Image Container - Reduced Height, clearer image */}
      <div className="relative h-48 w-full overflow-hidden bg-gray-100 dark:bg-[#121212] border-b border-gray-200 dark:border-[#27272a]">
        <img 
        ...
        <div className="absolute top-3 left-3 flex gap-2">
             <span className="px-2 py-1 bg-white/90 dark:bg-black/80 backdrop-blur-md text-[10px] font-bold uppercase tracking-wider text-gray-900 dark:text-white border border-gray-200 dark:border-white/10 rounded">
                {startup.stage}
             </span>
        </div>

        <div className="absolute top-3 right-3">
             <div className="bg-white/90 dark:bg-black/80 backdrop-blur-md w-8 h-8 flex items-center justify-center rounded border border-gray-200 dark:border-white/10 text-xs font-bold font-mono">
                {startup.score}
             </div>
        </div>
      </div>
      ...
      <div className="p-4 flex flex-col flex-1 bg-white dark:bg-[#09090b]">
        ...
        <div className="flex justify-between items-start mb-2">
            ...
            {/* Sparkline approximation or Icon */}
